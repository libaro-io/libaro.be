<x-layout>
    ...
    <div class="hidden max:block border-b-10 border-secondary"
        ...
        <div class="max:max-w-8xl mx-auto">
            ...
            <div class="pt-24">
                <x-header-single-column title="{{ __('expertise.apps.title') }}"
        ...
        <section class="max-w-8xl mx-auto px-4 max:px-0 pb-8 max:pb-24">
            <div class="mt-8 mb-12 leading-relaxed">
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.intro') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.apps.page.scoping.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.scoping.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.apps.page.prototyping.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.prototyping.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.apps.page.technical-specification.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.technical-specification.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.apps.page.interface-design.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.interface-design.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.apps.page.development.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.development.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.apps.page.launch.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.apps.page.launch.body') }}
                </p>
            </div>
        </section>
            ...
            <div class="max-w-8xl mx-auto p-4 lg:p-0">
                <div
                    ...
                    <img class="rounded-inner overflow-hidden w-full lg:h-620 object-cover object-top"
                         src='{{ asset("/storage/images/team_4.jpg") }}' alt="team pic">
                </div>
            </div>
        </section>
    </main>
