<x-layout>
    ...
    <div class="hidden max:block border-b-10 border-secondary"
        ...
        <div class="max:max-w-8xl mx-auto">
            ...
            <div class="pt-24">
                <x-header-single-column title="{{ __('expertise.ai.title') }}"
        ...
        <section class="max-w-8xl mx-auto px-4 max:px-0 pb-8 max:pb-24">
            <div class="mt-8 mb-12 leading-relaxed">
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.ai.page.intro') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.ai.page.chatbots.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.ai.page.chatbots.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.ai.page.data-mining.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.ai.page.data-mining.body') }}
                </p>
            </div>

            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.ai.page.approach.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.ai.page.approach.body') }}
                </p>
            </div>
            <div class="mt-8 mb-12 leading-relaxed">
                <h3 class="font-gilroy font-extrabold text-2xl lg:text-4xl text-primary-darkest mb-4">
                    {{ __('expertise.ai.page.lets-talk.title') }}
                </h3>
                <p class="font-grotesk font-semibold text-xl md:text-2xl text-primary-darkest">
                    {{ __('expertise.ai.page.lets-talk.body') }}
                </p>
            </div>
        </section>
