<x-layout>
    ...
    <main class="md:mt-24">
        <section class="max-w-8xl mx-auto md:mb-24 p-4">
            ...
            <p class="font-grotesk font-semibold text-xl text-primary-darkest xl:w-2/3">
            ...
            <p class="font-grotesk font-semibold text-xl text-primary-darkest mt-5 xl:w-2/3">
            ...
            <p
                class="font-grotesk font-semibold text-xl text-primary-darkest xl:w-2/3">
            ...
            <ul class="font-grotesk font-semibold text-xl text-primary-darkest mt-5 xl:w-2/3 ml-10 flex flex-col gap-3 list-disc">
            ...
            <ol class="font-grotesk font-semibold text-xl text-primary-darkest mt-5 xl:w-2/3 ml-10 flex flex-col gap-3 list-decimal">
            ...
            <div class="questions">
                <h2 class="font-gilroy font-bold text-3xl text-primary-darkest mt-12 mb-5">{{ __('Heeft u verdere vragen of ondersteuning nodig?') }}</h2>
                <a href="{{ route('timecard-support') }}"
                   class=" text-white font-grotesk font-semibold text-xl py-3 px-6 rounded-full inline-block bg-primary-dark hover:bg-primary-medium">
                    {{ __('Klik hier') }}
                </a>
            </div>
