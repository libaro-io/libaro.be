<x-layout>
    ...
    <x-nav-bottom-container :dark=true/>
        ...
        <main class="relative pt-32 max:pt-0">
            <div class="max-w-8xl px-12 max:px-0 pb-8 mx-auto">
                ...
                <h1 class="font-gilroy font-bold text-4xl md:text-7xl text-primary-darkest mb-10 md:mb-15">{{ $vacancy->title }}</h1>
            ...
            <section class="bg-primary-light border-b-20 border-project-border mt-32 md:mt-64 lg:mt-470">
                <div class="max-w-8xl mx-auto p-4 lg:p-0">
                    ...
                    <div class="flex flex-col lg:flex-row space-y-8 lg:space-y-0 items-center justify-center lg:-mt-32 mb-20">
