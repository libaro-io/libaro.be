<div class="mt-12">
    <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="{{ route('admin.quotes.store', ['showcase' => $showcase]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="by" id="by" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('by') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="job_title" id="job_title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('job_title') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="file" name="image_person" id="image_person" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('image_person') }}">
