        ...
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Delete this showcase and all it's keys and quotes.
                </p>
            </div>
        </div>
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="{{ route('admin.showcases.delete', ['showcase' => $showcase ]) }}" method="POST">
                @csrf
                @method('DELETE')
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                Showcase with id: {{ $showcase->id }}, which is currently
                                <span class="block font-bold bg-gray-100 px-2 py-1 mx-2">@if(!$showcase->visible)  not @endif visible </span>
                                on the site.
                            </div>
