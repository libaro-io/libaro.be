                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                ...
                                <input id="pin_on_homepage" name="pin_on_homepage" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" value="1" {{ old('pin_on_homepage') ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="visible" class="font-medium text-gray-700">Pin on the homepage</label>
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="type" id="type" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('type') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="date" name="date" id="date" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('date') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="text" name="client_url" id="client_url" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300" placeholder="www.example.com" value="{{ old('client_url') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="file" name="image_card" id="image_card" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('image_card') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="file" name="image_header" id="image_header" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('image_header') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="file" name="image_extra" id="image_extra" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('image_extra') }}">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="file" name="image_logo" id="image_logo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('image_logo') }}">
