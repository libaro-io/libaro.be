                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                ...
                                <input id="visible" name="visible" type="checkbox"
                                       ...
                                       value="1" {{ $article->visible ? 'checked' : '' }}>
                            </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <p class="text-sm text-gray-700 mt-2 ml-2">A comma seperated list of tags: one, two, with
                                multiple words, three</p>
                            @error('tags')
                            <div class="text-red-800 text-xs mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="date" name="publish_date" id="publish_date"
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                   value="{{ optional($article->publish_date)->format('Y-m-d') }}">
