<div class="my-12">
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6 mt-12">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="{{ route('admin.competences.delete', ['vacancy' => $vacancy, 'competence' => $competence ]) }}" method="POST">
                @csrf
                @method('DELETE')
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                Competence with id: {{ $competence->id }}, which is currently
                                <span class="block font-bold bg-gray-100 px-2 py-1 mx-2">@if(!$competence->visible)  not @endif visible </span>
                                on the site.
                            </div>
