<div style="background-image: url('{{ asset('/storage/images/header_striped.jpg') }}'); background-repeat: no-repeat; background-size: cover">
    <div class="xl:max-w-8xl mx-auto grid grid-cols-24 px-4 md:px-6 xl:px-0 xl:py-28">
        ...
        <h2 class="text-h3 font-gilroy font-bold leading-snug text-white sm:text-3xl md:text-4xl lg:text-5xl xl:text-7xl md:leading-tight flex items-center
        ...
        <a href="{{ route('contact-us') }}" class="group col-span-24 md:col-start-15 md:col-span-10">
            <button class="mb-10 text-white pl-7.5 py-5 bg-primary-medium bg-opacity-80 rounded-outer-md flex items-center
                          group-hover:bg-secondary-light group-hover:border-secondary-light
                          transition duration-500 ease-in-out">
                <span class="mr-6 font-grotesk font-extrabold text-base md:text-2xl">{{ __('cta.contact.button') }}</span>
