...
<li  class="{{ $fullScreen ? 'py-0' : 'py-4' }}">
    <a
        class="block font-grotesk font-extrabold text-white border-transparent rounded-full
               active:border-white active:bg-white active:text-secondary
               hover:border-white
               focus:bg-white focus:border-white
               transition duration-500 ease-in-out
               {{ $small ? 'text-md px-4 py-3 border-2' : 'text-md px-7 py-5 border-3px' }}
