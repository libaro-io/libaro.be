...
/* harmony import */ var _scripts_snow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/snow */ "./resources/js/scripts/snow.js");
...
(0,_scripts_snow__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
/* harmony export */ });
var letItSnow = function letItSnow() {
  ...
  var scaleFactor = isSmallScreen ? .75 : 1;
  var snowflakeCount = isSmallScreen ? 150 : 200;

  for (var i = 1; i < snowflakeCount; i++) {
    var rndX = random(0, 1000000) * 0.0001,
    ...
    snowflake.style.transform = "translate(".concat(rndX.toFixed(2), "vw, -10px) scale(").concat(rndS, ")");
    snowflake.style.animation = "fall-".concat(i, " ").concat(random(10, 30), "s -").concat(random(0, 30), "s linear infinite");
    snowContainer.appendChild(snowflake);
    css += "\n      @keyframes fall-".concat(i, " {\n        ").concat(rndT, "% {\n          transform: translate(").concat((rndX + rndO).toFixed(2), "vw, ").concat(rndT, "vh) scale(").concat(rndS, ");\n        }\n        100% {\n          transform: translate(").concat((rndX + rndO / 2).toFixed(2), "vw, 105vh) scale(").concat(rndS, ");\n        }\n      }\n    ");
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  ...
  var isDecemberOrJanuary = currentMonth === 11 || currentMonth === 0;
